...
/**
 * Component representing the footer, containing images and links to some of the technology used to build the application.
 */
...
class Footer extends React.Component {
  render() {
    return (
      <footer>
        <a
          href="https://github.com/stefangeneralao/troll-hunterz"
