...
export default class Controller {
  ...
  async youtubeEntry(req, res) {
    ...
    console.log(`${ username }: ${ numDisabledCommentSections } of disabled comment sections of ${ videosComments.length }.`);
    ...
    const collection = this.mongoClient.db('trollhunterz').collection('entries');
    try {
